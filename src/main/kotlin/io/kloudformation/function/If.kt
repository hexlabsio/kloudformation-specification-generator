...
data class If<T>(val condition: Condition, val trueValue: IfValue<T>, val falseValue: IfValue<T>):
       io.kloudformation.Value<T>, ImportValue.Value<T>, Select.ObjectValue<T>, SplitValue<T>, SubValue<T>, IfValue<T>, Intrinsic {
