...
): io.kloudformation.Value<T>, FindInMapValue<T>, ImportValue.Value<T>, SplitValue<T>, Select.IndexValue<T>, Select.ObjectValue<T>, SubValue<T>, IfValue<T>, ConditionalValue<T>{
